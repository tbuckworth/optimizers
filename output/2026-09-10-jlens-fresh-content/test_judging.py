...
SPEC = importlib.util.spec_from_file_location("fresh_judging_fixture_module", SOURCE)
...
def fabricated():
    ...
    edges = [(0, 6), (1, 12), (2, 18), (7, 13), (8, 19), (14, 20),
             (3, 9), (4, 15), (5, 21), (10, 16), (11, 22), (17, 23)]
    ...
    scores["scores"][0]["values"][j.IDS[6]] = 0.0
    scores["scores"][1]["values"][j.IDS[1]] = 1e-12
    scores["scores"][1]["values"][j.IDS[12]] = 0.0
...
class PureTests(unittest.TestCase):
    ...
    def test_response_rejection_and_strict_json(self):
        ...
        good = {"schema": "jlens_fresh_responses_v1", "packet_id": packet["packet_id"],
    ...
    def test_score_schema_nonfinite_bool_and_overflow_rejection(self):
        ...
        score["scores"][0]["values"][j.IDS[6]] = -1e308
        with self.assertRaises(ValueError):
...
class FileStages(unittest.TestCase):
    ...
    def seal(self):
        ...
        for rater in j.RATERS:
            ...
            response = {"schema": "jlens_fresh_responses_v1", "packet_id": packet["packet_id"],
                        "responses": [{"item_id": x, "choice": "FIRST"} for x in sorted(j._public_ids(packet))]}
