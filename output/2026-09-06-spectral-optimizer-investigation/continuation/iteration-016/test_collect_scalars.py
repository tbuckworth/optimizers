"""Synthetic CPU-only integrity tests for the I16 scalar collector."""
...
class CollectorTests(unittest.TestCase):
    def fixture(self, root: Path):
        ...
        for phase in collector.PHASES:
            ...
            completion = {"schema": "i16_completion_v1", "status": "complete",
            ...
            attempt = {"schema": "i16_attempt_v1", "phase": phase,
