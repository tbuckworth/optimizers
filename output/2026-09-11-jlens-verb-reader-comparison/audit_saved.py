...
STUDY = WORKER/'output/2026-09-11-j-lens-verb-reader-comparison'
SCORE = WORKER/'output/2026-09-11-j-lens-new-verb-transfer/forwards/scores.json'
SCORE_SHA = '431ec80549b0eea2f4b7770f28839696211247ef91275c9349e80b23b430c55b'
...
def run(grade_path, expected):
    ...
    assert grade['schema'] == 'jlens_verb_reader_grades_v1'
    ...
    assert digest(SCORE) == SCORE_SHA == provenance['scores']['sha256']
    scores = {x['axis']: x['values'] for x in read(SCORE)['locations']['verb']}
